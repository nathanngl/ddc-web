...
return [
    ...
    */
    ...
    'max' => [
        'numeric' => 'Field :attribute maskimal bernilai :max.',
        'file' => 'Field :attribute maksimal berukuran :max kilobita.',
        'string' => 'Field :attribute maskimal berisi :max karakter.',
        'array' => 'Field :attribute maksimal terdiri dari :max anggota.',
    ],
    'mimes' => 'Field :attribute harus berupa berkas berjenis: :values.',
    'mimetypes' => 'Field :attribute harus berupa berkas berjenis: :values.',
    'min' => [
        'numeric' => 'Field :attribute minimal bernilai :min.',
        'file' => 'Field :attribute minimal berukuran :min kilobita.',
        'string' => 'Field :attribute minimal berisi :min karakter.',
        'array' => 'Field :attribute minimal terdiri dari :min anggota.',
    ],
    ...
    'required_without_all' => 'Field :attribute wajib diisi bila sama sekali tidak terdapat :values.',
    'same' => 'Field :attribute dan field :other harus sama.',
    'size' => [
        ...
        'array' => 'Field :attribute harus mengandung :size anggota.',
    ],
    'starts_with' => 'Field :attribute harus diawali salah satu dari berikut: :values',
